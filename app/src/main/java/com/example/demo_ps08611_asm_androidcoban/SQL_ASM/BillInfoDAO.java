...
public class BillInfoDAO {
    ...
    //insert
    public int inserHoaDonChiTiet(HDCTmodel hd) {
    ...
    //getAll
    public List<HDCTmodel> getAllHoaDonChiTiet() {
        List<HDCTmodel> dsHoaDonChiTiet = new ArrayList<>();
        ...
        try {
            while (c.isAfterLast() == false) {
                HDCTmodel ee = new HDCTmodel();
                ee.setMaHDCT(c.getInt(0));
                ee.setHoaDon(new HoaDonModel(c.getString(1), sdf.parse(c.getString(2))));
                ee.setSach(new
                        Bookmodel(c.getString(3), c.getString(4), c.getString(5), c.getString(6), c.getString(7), c.getInt(8), c.getInt(9)));
    ...
    //getAll
    public List<HDCTmodel> getAllHoaDonChiTietByID(String maHoaDon) {
        List<HDCTmodel> dsHoaDonChiTiet = new ArrayList<>();
    ...
    //update
    public int updateHoaDonChiTiet(HDCTmodel hd) {
        ContentValues values = new ContentValues();
